...
public class Voxelizer : MonoBehaviour {
	...
	public bool addCollectableScript = false;
	...
	public void GenerateVoxelInstant() {
		...
		foreach (Transform child in transform) {
            ...
            if (addCollectableScript)
            {
				CollectableItem item = child.gameObject.GetComponent<CollectableItem>();

				if (!item)
				{
					child.gameObject.AddComponent<CollectableItem>();
				}
			}
		}
	}
